...
class HighSeasonTour(Tour):

    def __init__(self):
        super().__init__()
        self._service_charge = 300  # default
    ...
    def seasonal_price_calculation(self, people_count, price_per_person):
        ...
        self._tour_price = self._service_charge + price
    ...
    def get_tour_season(self):
        return self._tour_season

    def set_tour_season(self, tourSeason):
        self._tour_season = tourSeason
